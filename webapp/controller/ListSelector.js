sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("ZYaniv_GIT.zyaniv_git.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias ZYaniv_GIT.zyaniv_git.controller.ListSelector
			 */
			 ...
			 * @return {ZYaniv_GIT.zyaniv_git.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
