sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("ZYaniv_GIT/zyaniv_git/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#YanivGIT-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#YanivGIT-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("ZYaniv_GIT.zyaniv_git.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["ZYaniv_GIT/zyaniv_git/localService/mockserver"], function (mockserver) {
